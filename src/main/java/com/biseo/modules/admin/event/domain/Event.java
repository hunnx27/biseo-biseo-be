package com.biseo.modules.admin.event.domain;

import com.biseo.common.util.dto.AttachDto;
import com.biseo.common.web.dto.response.enums.YN;
import com.biseo.modules.admin.event.domain.enums.Landding;
import com.biseo.modules.admin.event.domain.enums.LanddingConverter;
import com.biseo.modules.admin.event.domain.enums.PopupLocation;
import com.biseo.modules.admin.event.domain.enums.PopupLocationConverter;
import com.biseo.modules.admin.event.web.dto.EventCreateRequestDto;
import com.biseo.modules.admin.notice.domain.enums.DeviceGubn;
import com.biseo.modules.counsel.domain.embed.Images2;

package com.biseo.modules.admin.menu.application;

import com.biseo.common.exception.CustomException;
import com.biseo.common.web.ApiR;
import com.biseo.modules.admin.menu.domain.Menu;
import com.biseo.modules.admin.menu.infra.MenuRepository;
import com.biseo.modules.admin.menu.web.dto.response.MenuSelectResponseDto;
import com.biseo.modules.auth.web.dto.UserPrincipal;
import com.biseo.modules.admin.menu.web.dto.request.MenuRequsetDto;
...
import static com.biseo.common.web.dto.response.enums.ErrorCode.DUPLICATE_RESOURCE;
import static com.biseo.common.web.dto.response.enums.ErrorCode.NOT_ACCEPTABLE;
